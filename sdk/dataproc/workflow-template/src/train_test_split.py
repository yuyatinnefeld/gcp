...
def main():
	...
	df = pd.read_csv('data/training.1600000.processed.noemoticon.csv', encoding = 'ISO-8859-1',names=cols)
	# shuffle the data
	...
	train.to_csv('data/pyspark_sa_train_data.csv')
	test.to_csv('data/pyspark_sa_test_data.csv')
